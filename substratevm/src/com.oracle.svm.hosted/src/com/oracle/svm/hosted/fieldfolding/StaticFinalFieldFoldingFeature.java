...
public final class StaticFinalFieldFoldingFeature implements InternalFeature {
    ...
    private void methodAfterBytecodeParsedListener(AnalysisMethod method, StructuredGraph graph) {
        /*
         * This method is registered as callback for the first parsing stage. If the parsed method
         * is not a class initializer, we only check if there are stores to static final fields. It
         * is sufficient to do this check in the final stage.
         */
    ...
    private void methodAfterParsingListener(AnalysisMethod method, StructuredGraph graph) {
        analyzeParsedMethod(Stage.AFTER_PARSING_HOOKS_DONE, method, graph);
    }
